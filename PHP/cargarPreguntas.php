<?php
    ...
    $sql = "SELECT * FROM BD.preguntas INNER JOIN BD.problemas ON problema = idProblema AND torneo = $idTorneo WHERE responde is null AND usuario = '$usuario' ORDER BY idPregunta DESC;";
