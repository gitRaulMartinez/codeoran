        ...
        <div style="width: 100%; display: flex; font-size:15px">
            <div style="width:auto; min-width: 400px; margin: 0 auto; background: #212020; color: white;">
                <div style="margin: 10px;">
                    ...
                    <p>¡Hola '.$usuario.'!, recibimos una petición de reenvió de código para activar la cuenta, esto es necesario para poder participar de los torneos. Copie y pegue el código siguiente. </p>
                    <br>
                </div>  
